...
public class CountryUtils_app {
    private static List<Country_app> countries;
    private static Map<String, List<String>> time_zone_and_country_isos;


    public static int getFlagDrawableResId(Country_app country) {
    ...
    static List<Country_app> getAllCountries(Context context) {
        ...
        countries.add(new Country_app(context.getString(R.string.country_botswana_code),
                context.getString(R.string.country_botswana_number),
                context.getString(R.string.country_botswana_name)));

        countries.add(new Country_app(context.getString(R.string.country_brazil_code),
                context.getString(R.string.country_brazil_number),
                context.getString(R.string.country_brazil_name)));

        countries.add(new Country_app(context.getString(R.string.country_british_virgin_islands_code),
        ...
        countries.add(new Country_app(context.getString(R.string.country_chad_code),
                context.getString(R.string.country_chad_number),
                context.getString(R.string.country_chad_name)));

        countries.add(new Country_app(context.getString(R.string.country_chile_code),
                context.getString(R.string.country_chile_number),
                context.getString(R.string.country_chile_name)));

        countries.add(new Country_app(context.getString(R.string.country_china_code),
                context.getString(R.string.country_china_number),
                context.getString(R.string.country_china_name)));

        countries.add(new Country_app(context.getString(R.string.country_christmas_island_code),
                context.getString(R.string.country_christmas_island_number),
                context.getString(R.string.country_christmas_island_name)));

        countries.add(new Country_app(context.getString(R.string.country_cocos_keeling_islands_code),
        ...
        countries.add(new Country_app(context.getString(R.string.country_colombia_code),
                context.getString(R.string.country_colombia_number),
                context.getString(R.string.country_colombia_name)));

        countries.add(new Country_app(context.getString(R.string.country_comoros_code),
                context.getString(R.string.country_comoros_number),
                context.getString(R.string.country_comoros_name)));

        countries.add(new Country_app(context.getString(R.string.country_congo_code),
                context.getString(R.string.country_congo_number),
                context.getString(R.string.country_congo_name)));

        countries.add(
                new Country_app(context.getString(R.string.country_the_democratic_republic_of_congo_code),
        ...
        countries.add(new Country_app(context.getString(R.string.country_saint_lucia_code),
                context.getString(R.string.country_saint_lucia_number),
                context.getString(R.string.country_saint_lucia_name)));

        countries.add(new Country_app(context.getString(R.string.country_saint_vincent_the_grenadines_code),
        ...
        countries.add(new Country_app(context.getString(R.string.country_samoa_code),
                context.getString(R.string.country_samoa_number),
                context.getString(R.string.country_samoa_name)));

        countries.add(new Country_app(context.getString(R.string.country_san_marino_code),
                context.getString(R.string.country_san_marino_number),
                context.getString(R.string.country_san_marino_name)));

        countries.add(new Country_app(context.getString(R.string.country_sao_tome_and_principe_code),
        ...
        countries.add(new Country_app(context.getString(R.string.country_tuvalu_code),
                context.getString(R.string.country_tuvalu_number),
                context.getString(R.string.country_tuvalu_name)));

        countries.add(new Country_app(context.getString(R.string.country_united_arab_emirates_code),
        ...
        countries.add(new Country_app(context.getString(R.string.country_palestian_territory_code),
                context.getString(R.string.country_palestian_territory_number),
                context.getString(R.string.country_palestian_territory_name)));

        countries.add(new Country_app(context.getString(R.string.country_saint_martin_code),
                context.getString(R.string.country_saint_martin_number),
                context.getString(R.string.country_saint_martin_name)));

        countries.add(new Country_app(context.getString(R.string.country_south_georgia_code),
                context.getString(R.string.country_south_georgia_number),
                context.getString(R.string.country_south_georgia_name)));

        Collections.sort(countries, new Comparator<Country_app>() {
            @Override
            public int compare(Country_app country1, Country_app country2) {
    ...
    static Country_app getByNumber(Context context, List<Country_app> preferredCountries, String fullNumber) {
        int firstDigit;
    ...
    static Country_app getByCode(Context context, List<Country_app> preferredCountries, int code) {
        return getByCode(context, preferredCountries, code + "");
    }


    private static Country_app getByCode(Context context, List<Country_app> preferredCountries, String code) {


        if (preferredCountries != null && !preferredCountries.isEmpty()) {
            for (Country_app country : preferredCountries) {
                if (country.getPhone_code().equals(code)) {
                    return country;
                }
            }
        }

        for (Country_app country : CountryUtils_app.getAllCountries(context)) {
            if (country.getPhone_code().equals(code)) {
                return country;
            }
        }
    ...
    static Country_app getByNameCodeFromCustomCountries(Context context,
                                                        List<Country_app> customCountries,
                                                        String nameCode) {
        if (customCountries == null || customCountries.size() == 0) {
            return getByNameCodeFromAllCountries(context, nameCode);
        } else {
            for (Country_app country : customCountries) {
    ...
    static Country_app getByNameCodeFromAllCountries(Context context, String nameCode) {
        List<Country_app> countries = CountryUtils_app.getAllCountries(context);
        for (Country_app country : countries) {
            if (country.getIso().equalsIgnoreCase(nameCode)) {
                return country;
            }
        }
    ...
    private static Map<String, List<String>> getTimeZoneAndCountryISOs(Context context) {
        if (time_zone_and_country_isos != null && !time_zone_and_country_isos.isEmpty()) {
            return time_zone_and_country_isos;
        }

        time_zone_and_country_isos = new HashMap<>();
                ...
                if (lineJustFetched == null) {
                    ...
                    if (!lineJustFetched.substring(0, 1).contains("#")) {
                        if (wordsArray.length >= 3) {
                            ...
                            time_zone_and_country_isos.put(wordsArray[2], isos);
                        }
                    }
                }
            }
